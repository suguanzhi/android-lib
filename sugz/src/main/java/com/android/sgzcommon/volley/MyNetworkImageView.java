...
public class MyNetworkImageView extends ImageView {
	 ...
	 * 
	 * NOTE: If applicable, {@link MyNetworkImageView#setDefaultImageResId(int)}
	 * and {@link MyNetworkImageView#setErrorImageResId(int)} should be called
	...
	private void loadImageIfNecessary(final boolean isInLayoutPass) {
		...
		ImageContainer newContainer = mImageLoader.get(mUrl, new ImageListener() {
			...
			public void onErrorResponse(VolleyError error) {
				...
				if (mListener != null) {
					mListener.onResponse(MyNetworkImageView.this, false);
				}
			}
			...
			public void onResponse(final ImageContainer response, boolean isImmediate) {
				...
				if (response.getBitmap() != null) {
					loadDone = true;
					if (mListener != null) {
						mListener.onResponse(MyNetworkImageView.this, true);
					}
	...
	public interface OnResponseListener {
		void onResponse(View view, boolean success);
	}
}
